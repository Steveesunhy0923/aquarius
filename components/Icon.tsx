...
const PATHS = {
  ...
  maximize: '<path d="M15 3h6v6" /><path d="m21 3-7 7" /><path d="m3 21 7-7" /><path d="M9 21H3v-6" />', // lucide/maximize-2
  ...
  codeblock: '<path d="m10 9-3 3 3 3" /><path d="m14 15 3-3-3-3" /><rect width="18" height="18" x="3" y="3" rx="2" />', // lucide/square-code
  play: '<polygon points="6 3 20 12 6 21 6 3" />', // lucide/play
  stop: '<rect width="14" height="14" x="5" y="5" rx="2" />', // lucide/square (stop)
  restart: '<path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8" /><path d="M21 3v5h-5" />', // lucide/rotate-cw
